...
import com.parishod.chatGenieX.NotificationService;
import com.parishod.chatGenieX.R;
import com.parishod.chatGenieX.activity.about.AboutActivity;
import com.parishod.chatGenieX.activity.customreplyeditor.CustomReplyEditorActivity;
import com.parishod.chatGenieX.activity.enabledapps.EnabledAppsActivity;
import com.parishod.chatGenieX.activity.settings.SettingsActivity;
...
import com.parishod.chatGenieX.model.preferences.PreferencesManager;
import com.parishod.chatGenieX.model.utils.Constants;
import com.parishod.chatGenieX.model.utils.CustomDialog;
import com.parishod.chatGenieX.model.utils.DbUtils;
import com.parishod.chatGenieX.model.utils.ServieUtils;
...
import static com.parishod.chatGenieX.model.utils.Constants.MAX_DAYS;
import static com.parishod.chatGenieX.model.utils.Constants.MIN_DAYS;
import static com.parishod.chatGenieX.model.utils.Constants.MIN_REPLIES_TO_ASK_APP_RATING;
...
//                launchNotificationAccessSettings();
    ...
    private void launchFeedbackApp() {
        ...
        if (!isLaunched) { // Open Github latest release url in browser if everything else fails
            String url = getString(R.string.chatGenieX_github_latest_release_url);
