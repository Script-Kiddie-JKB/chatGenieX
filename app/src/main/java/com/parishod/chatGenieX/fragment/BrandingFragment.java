...
import com.parishod.chatGenieX.activity.donation.DonationActivity;
...
import com.parishod.chatGenieX.network.GetReleaseNotesService;
import com.parishod.chatGenieX.network.RetrofitInstance;
...
public class BrandingFragment extends Fragment {
    private Button chatGenieXSubredditBtn, whatsNewBtn;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton githubBtn = view.findViewById(R.id.chatGenieXGithubBtn);
        ImageButton share_layout = view.findViewById(R.id.share_btn);
        chatGenieXSubredditBtn = view.findViewById(R.id.chatGenieXSubredditBtn);
        ...
        chatGenieXSubredditBtn.setOnClickListener(v -> {
            String url = getString(R.string.chatGenieX_subreddit_url);
            startActivity(
        ...
        githubBtn.setOnClickListener(v -> {
            String url = getString(R.string.chatGenieX_github_url);
            startActivity(
                    new Intent(ACTION_VIEW).setData(Uri.parse(url))
            );
        });
    ...
    private void showHideWhatsNewBtn(boolean show) {
        chatGenieXSubredditBtn.setVisibility(show ? View.GONE : View.VISIBLE);
