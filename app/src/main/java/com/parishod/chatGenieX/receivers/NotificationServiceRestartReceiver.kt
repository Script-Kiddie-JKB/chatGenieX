package com.parishod.chatGenieX.receivers
...
import com.parishod.chatGenieX.service.KeepAliveService
...
class NotificationServiceRestartReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (action?.equals(Intent.ACTION_BOOT_COMPLETED) == true
                || action?.equals("ChatGenieX-RestartService-Broadcast") == true) {
