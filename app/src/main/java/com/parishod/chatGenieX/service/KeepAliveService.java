package com.parishod.chatGenieX.service;
...
import com.parishod.chatGenieX.receivers.NotificationServiceRestartReceiver;
...
//        super.onStartCommand(intent, flags, startId);
    ...
    public void tryReconnectService() {
        if (PreferencesManager.getPreferencesInstance(getApplicationContext()).isServiceEnabled()
            ...
            broadcastIntent.setAction("ChatGenieX-RestartService-Broadcast");
